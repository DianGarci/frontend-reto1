...
const butIniciarSesion = document.getElementById("BotonIngresar");

const emailInicioSesion = document.getElementById("useremail");
...
function guardarNuevoUser(RegNombre, RegEmail, RegPassword1) {
    ...
    $.ajax({
        ...
        url: 'http://129.151.110.14:8081/api/user/new',
        type: 'POST',
        dataType: 'json',
